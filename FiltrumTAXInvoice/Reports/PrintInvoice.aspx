<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintInvoice.aspx.cs" Inherits="Reports_PrintInvoice" %>
            ...
            <tr>
                <td style="width: 99px" valign="top">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="800px" Height="1000px" ZoomMode="PageWidth" Font-Names="Verdana" Font-Size="8pt" ShowToolBar="False" SizeToReportContent="True">
                        <LocalReport ReportPath="App_Code\Reports\PrintInvoice.rdlc">
                            <DataSources>
                                ...
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Invoice7" />
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="Invoice8" />
                            </DataSources>
